		...
		<div class="profile-right">
					...
					<c:otherwise>
						<c:choose>
							<c:when test="${dto.subscribeState }">
								<button class="cta " onclick="toggleSubscribe(${dto.user.id},this)">팔로우 끊기</button>
							</c:when>
							<c:otherwise>
			...
			<div class="subscribe">
				<ul>
					...
					<li><a href="javascript:subscribeInfoModalOpenDo(${dto.user.id});"> 팔로워<span>${dto.subscribeDo}</span>
					</a></li>
				</ul>
			</div>
